...
def calc_color_hist(image):
    # b, g, r
    hist = []
    hist.append(cv2.calcHist([image], [0], mask=None, histSize=[256], ranges=[0, 256]))
    hist.append(cv2.calcHist([image], [1], mask=None, histSize=[256], ranges=[0, 256]))
    hist.append(cv2.calcHist([image], [2], mask=None, histSize=[256], ranges=[0, 256]))
    return hist
